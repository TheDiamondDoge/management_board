...
INSERT INTO prj_risks VALUES (1, 1, '1.1', 4, '70%', 2.8, 1.0, 1.0, 'Many products in parallel', 'Overloaded Metiers', 'Business impact indeed', 'FAst response, Sonic style', 'Mitigation:Priority on content\nLast chance corrective action:Delay product availability or some major content', '2020-12-15', '1000ME', '2000ME', 'Iksanov', '12CaE', '2020-12-15', '2020-12-15', '2020-12-15', 0);
INSERT INTO prj_risks VALUES (1, 2, '1.2', 4, '70%', 2.8, 1.0, 1.0, 'Many products in parallel', 'Overloaded Metiers', 'Business impact indeed', 'FAst response, Sonic style', 'Mitigation:Priority on content\nLast chance corrective action:Delay product availability or some major content', '2020-12-15', '1000ME', '2000ME', 'Iksanov', '12CaE', '2020-12-15', '2020-12-15', '2020-12-15', 1);
INSERT INTO prj_risks VALUES (1, 3, '1.3', 4, '70%', 2.8, 1.0, 1.0, 'Many products in parallel', 'Overloaded Metiers', 'Business impact indeed', 'FAst response, Sonic style', 'Mitigation:Priority on content\nLast chance corrective action:Delay product availability or some major content', '2020-12-15', '1000ME', '2000ME', 'Iksanov', '12CaE', '2020-12-15', '2020-12-15', '2020-12-15', 0);
INSERT INTO prj_risks VALUES (1, 4, '1.4', 4, '70%', 2.8, 1.0, 1.0, 'Many products in parallel', 'Overloaded Metiers', 'Business impact indeed', 'FAst response, Sonic style', 'Mitigation:Priority on content\nLast chance corrective action:Delay product availability or some major content', '2020-12-15', '1000ME', '2000ME', 'Iksanov', '12CaE', '2020-12-15', '2020-12-15', '2020-12-15', 1);
INSERT INTO prj_risks VALUES (1, 5, '1.5', 4, '70%', 2.8, 1.0, 1.0, 'Many products in parallel', 'Overloaded Metiers', 'Business impact indeed', 'FAst response, Sonic style', 'Mitigation:Priority on content\nLast chance corrective action:Delay product availability or some major content', '2020-12-15', '1000ME', '2000ME', 'Iksanov', '12CaE', '2020-12-15', '2020-12-15', '2020-12-15', 0);
